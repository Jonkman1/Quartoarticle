...
We present the results of exploratory data analysis and the regression model.
...
We show two histograms displaying the distributions of `price` and `area` individually.
...
The figure displays the relationship between these two variables in a scatterplot.
...
This figure displays basic summary statistics for these two variables.
...
We can fit a simple linear regression model of the form shown.


It shows the regression output for this model.
